...
<title>Consultas de conferencistas </title>
</head>
<body>
<?php
$dbhost = "localhost";
...
$sql = "SELECT nombre,apellido,profesion,biografia,correo FROM lpineda.conferencistas;";

$result = $conn->query($sql);
echo "<table>";
echo "<tr> <th>nombre</th><<th>apellido</th><<th>profesion</th><<th>biografia</th> <<th>correo</th> </tr>";
